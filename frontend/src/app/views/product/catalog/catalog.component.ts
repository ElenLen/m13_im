  ...
  ngOnInit(): void {
    ...
    this.cartService.getCart()
      .subscribe((data: CartType | DefaultResponseType) => {
        ...
        // если не авторизован, запрос не делаем
  ...
  processCatalog() {
    this.categoryService.getCategoriesWithTypes()
      .subscribe(data => {
        ...
        // подписываемся на роут
        this.activatedRoute.queryParams
          // промежут обработка, задержка отправки запроса при смене фильтра на 500
          .pipe(
            debounceTime(500)
          )
          .subscribe(params => {
            ...
            // запрос на получение продуктов по фильтру
            this.productService.getProducts(this.activeParams)
              .subscribe(data => {
                ...
                // если есть в избранном, меняем флаг
